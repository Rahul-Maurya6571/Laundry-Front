...
function OrderContent() {
    ...
    useEffect(() => {
        fetch("https://laundry-back-n4s1.onrender.com/getorder", {
            method: "GET",
            headers: {
    ...
    const deleteItem = (id) => {
        fetch("https://laundry-back-n4s1.onrender.com/deleteorder", {
            method: "delete",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("jwt"),
                "Content-Type": "application/json"
    ...
    const findServiceArray = (id) => {
        fetch("https://laundry-back-n4s1.onrender.com/findorder", {
            method: "POST",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("jwt"),
                "Content-Type": "application/json"
